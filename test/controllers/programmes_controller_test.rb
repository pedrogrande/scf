...
class ProgrammesControllerTest < ActionController::TestCase
  ...
  test "should create programme" do
    assert_difference('Programme.count') do
      post :create, programme: { end_date_time: @programme.end_date_time, start_date_time: @programme.start_date_time, user_id: @programme.user_id }
    end
  ...
  test "should update programme" do
    patch :update, id: @programme, programme: { end_date_time: @programme.end_date_time, start_date_time: @programme.start_date_time, user_id: @programme.user_id }
    assert_redirected_to programme_path(assigns(:programme))
  end
